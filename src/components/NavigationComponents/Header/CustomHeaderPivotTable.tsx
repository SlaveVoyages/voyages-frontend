...
const CustomHeaderPivotTable: React.FC<Props> = (props) => {
  ...
  const fetchDataPivotTable = useCallback(
    async (sortOrder: SortOrder, sortingOrder: string[]) => {
    ...
    sort = (
      ...
      >
        <div
          ...
          onKeyDown={(e) => {
            if (e.key === 'Enter' || e.key === ' ')
              onSortRequested('asc', { shiftKey: e.shiftKey } as any);
          }}
        ...
        <div
          ...
          onKeyDown={(e) => {
            if (e.key === 'Enter' || e.key === ' ')
              onSortRequested('desc', { shiftKey: e.shiftKey } as any);
          }}
